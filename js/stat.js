...
window.renderStatistics = function (ctx, players, times) {
  ...
  drawText(ctx, 'Ура вы победили!', Cloud.X + GAP * 3, Cloud.Y + GAP * 3);
  drawText(ctx, 'Список результатов:', Cloud.X + GAP * 3, Cloud.Y + GAP * 3 + FONT_GAP);
  ...
  for (var i = 0; i < players.length; i++) {
    ...
    drawText(ctx, Math.round(times[i]), barX, Cloud.BOTTOM - GAP * 3 - FONT_GAP * 1.5 - barItemHeight); // 2345.54654654654
  }
};
